...
const test_1 = tslib_1.__importDefault(require("./routers/test"));
...
const corsOptionsDelegate = (req, callback) => {
    ...
    if (origin && (allowedStaticDomains.includes(origin) || origin.endsWith(".vercel.app"))) {
