...
const user_1 = require("@/web/routers/user");
const project_1 = require("@/web/routers/project");
const task_1 = require("@/web/routers/task");
const members_1 = require("@/web/routers/members");
